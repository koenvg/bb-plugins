...
describe("task attachments", () => {
  it("builds a Tasks Plus download URL with an encoded attachment ID", () => {
    expect(attachmentDownloadUrl("att/1")).toBe(
      "/api/v1/plugins/tasks-plus/http/attachments/download?attachmentId=att%2F1",
    );
  });
