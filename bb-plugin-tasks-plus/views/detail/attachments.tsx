...
import { attachmentDownloadUrl, TASKS_PLUS_API_BASE } from "../../shared/attachments.js";
...
function pluginToken(): Promise<string> {
  tokenPromise ??= (async () => {
    const response = await fetch(`${TASKS_PLUS_API_BASE}/token`, {
      method: "POST",
...
export async function uploadAttachment(
  ...
  const response = await fetch(
    `${TASKS_PLUS_API_BASE}/http/attachments/upload?${query.toString()}`,
    {
      method: "POST",
